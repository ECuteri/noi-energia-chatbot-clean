...
async def create_noi_energia_chatbot_agent():
    list_documents = create_list_documents_tool(
        table_name="noi_energia_documents",
        metadata_table_name="noi_energia_documents_metadata",
        chatbot_name="Noi Energia",
    )
    ...
    vector_search = create_vector_search_tool(
        table_name="noi_energia_documents", chatbot_name="Noi Energia"
    )
    ...
    return await create_chatbot_agent(
        chatbot_name="Noi Energia Chatbot",
